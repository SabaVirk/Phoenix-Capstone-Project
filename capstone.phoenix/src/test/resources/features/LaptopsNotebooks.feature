@Laptops&NoteBooksPage 
Feature: Test Environment Laptop & NoteBooks 
...
Then User should get a message for Sony 'You must login or create an account to save Sony VAIO to your wish list!'
